from typing import Iterable, List, Dict, Mapping, Sequence
...
class LivePlotCollector(cirq.Collector):
    ...
    def __init__(self,
        ...
        self.result_ys: Mapping[
            str, List[float]] = collections.defaultdict(list)
    ...
    def next_job(self):
        ...
        return cirq.CircuitSampleJob(
            cirq.resolve_parameters(self.circuit, self.resolvers[k]),
