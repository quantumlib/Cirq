...
https://quantumai.google/cirq/dev/development and perform a
local testing of their change to ensure it is ready for review.

Please confirm with a short comment when this is done.  The comment
should state the Python version and the Operating System used for testing,
for example,

  All check/all tests pass locally using Python 3.13
