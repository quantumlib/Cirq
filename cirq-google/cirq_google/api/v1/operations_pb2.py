...
_PARAMETERIZEDFLOAT = DESCRIPTOR.message_types_by_name['ParameterizedFloat']
_EXPW = DESCRIPTOR.message_types_by_name['ExpW']
_EXPZ = DESCRIPTOR.message_types_by_name['ExpZ']
_EXP11 = DESCRIPTOR.message_types_by_name['Exp11']
