...
_PARAMETERSWEEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='repetitions',
            full_name='cirq.google.api.v1.ParameterSweep.repetitions',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='sweep',
            full_name='cirq.google.api.v1.ParameterSweep.sweep',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PRODUCTSWEEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='factors',
            full_name='cirq.google.api.v1.ProductSweep.factors',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ZIPSWEEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='sweeps',
            full_name='cirq.google.api.v1.ZipSweep.sweeps',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SINGLESWEEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='parameter_key',
            full_name='cirq.google.api.v1.SingleSweep.parameter_key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='points',
            full_name='cirq.google.api.v1.SingleSweep.points',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='linspace',
            full_name='cirq.google.api.v1.SingleSweep.linspace',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name='sweep',
            full_name='cirq.google.api.v1.SingleSweep.sweep',
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_POINTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='points',
            full_name='cirq.google.api.v1.Points.points',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_LINSPACE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='first_point',
            full_name='cirq.google.api.v1.Linspace.first_point',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='last_point',
            full_name='cirq.google.api.v1.Linspace.last_point',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='num_points',
            full_name='cirq.google.api.v1.Linspace.num_points',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
_PARAMETERDICT_ASSIGNMENTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='cirq.google.api.v1.ParameterDict.AssignmentsEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='cirq.google.api.v1.ParameterDict.AssignmentsEntry.value',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_PARAMETERDICT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='assignments',
            full_name='cirq.google.api.v1.ParameterDict.assignments',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
ProductSweep = _reflection.GeneratedProtocolMessageType(
    'ProductSweep',
    (_message.Message,),
    {
...
ZipSweep = _reflection.GeneratedProtocolMessageType(
    'ZipSweep',
    (_message.Message,),
    {
...
ParameterDict = _reflection.GeneratedProtocolMessageType(
    'ParameterDict',
    (_message.Message,),
    {
        'AssignmentsEntry': _reflection.GeneratedProtocolMessageType(
            'AssignmentsEntry',
            (_message.Message,),
            {
