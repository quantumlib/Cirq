...
import sys
from cirq_google.api.v2.program_pb2 import Program as cirq_google___api___v2___program_pb2___Program

from cirq_google.api.v2.result_pb2 import Result as cirq_google___api___v2___result_pb2___Result
...
class BatchProgram(google___protobuf___message___Message):
    ...
    def programs(
        ...
        cirq_google___api___v2___program_pb2___Program
    ]: ...
    def __init__(
        self,
        programs: typing___Optional[
            typing___Iterable[cirq_google___api___v2___program_pb2___Program]
        ] = None,
    ) -> None: ...
    @classmethod
...
class BatchRunContext(google___protobuf___message___Message):
    ...
    def run_contexts(
        ...
        cirq_google___api___v2___run_context_pb2___RunContext
    ]: ...
    def __init__(
        self,
        run_contexts: typing___Optional[
            typing___Iterable[cirq_google___api___v2___run_context_pb2___RunContext]
        ] = None,
    ) -> None: ...
    @classmethod
...
class BatchResult(google___protobuf___message___Message):
    ...
    def results(
        ...
        cirq_google___api___v2___result_pb2___Result
    ]: ...
    def __init__(
        self,
        results: typing___Optional[
            typing___Iterable[cirq_google___api___v2___result_pb2___Result]
        ] = None,
    ) -> None: ...
    @classmethod
