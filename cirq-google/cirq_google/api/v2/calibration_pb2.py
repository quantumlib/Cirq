...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'cirq_google/api/v2/calibration.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CALIBRATIONLAYER_ARGSENTRY']._loaded_options = None
  _globals['_CALIBRATIONLAYER_ARGSENTRY']._serialized_options = b'8\001'
