...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        cirq__google_dot_api_dot_v2_dot_metrics__pb2.DESCRIPTOR,
        cirq__google_dot_api_dot_v2_dot_program__pb2.DESCRIPTOR,
    ],
)
...
_CALIBRATIONLAYERCODE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='CALIBRATION_RESULT_UNSPECIFIED',
            index=0,
            number=0,
...
_FOCUSEDCALIBRATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='layers',
            full_name='cirq.google.api.v2.FocusedCalibration.layers',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CALIBRATIONLAYER_ARGSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='cirq.google.api.v2.CalibrationLayer.ArgsEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='cirq.google.api.v2.CalibrationLayer.ArgsEntry.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_CALIBRATIONLAYER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.google.api.v2.CalibrationLayer.calibration_type',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='layer',
            full_name='cirq.google.api.v2.CalibrationLayer.layer',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='args',
            full_name='cirq.google.api.v2.CalibrationLayer.args',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_FOCUSEDCALIBRATIONRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='results',
            full_name='cirq.google.api.v2.FocusedCalibrationResult.results',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CALIBRATIONLAYERRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='code',
            full_name='cirq.google.api.v2.CalibrationLayerResult.code',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='error_message',
            full_name='cirq.google.api.v2.CalibrationLayerResult.error_message',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='token',
            full_name='cirq.google.api.v2.CalibrationLayerResult.token',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='metrics',
            full_name='cirq.google.api.v2.CalibrationLayerResult.metrics',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='valid_until_ms',
            full_name='cirq.google.api.v2.CalibrationLayerResult.valid_until_ms',
            index=4,
            number=5,
            type=4,
            cpp_type=4,
...
_CALIBRATIONLAYER_ARGSENTRY.fields_by_name[
    'value'
].message_type = cirq__google_dot_api_dot_v2_dot_program__pb2._ARG
_CALIBRATIONLAYER_ARGSENTRY.containing_type = _CALIBRATIONLAYER
_CALIBRATIONLAYER.fields_by_name[
    'layer'
].message_type = cirq__google_dot_api_dot_v2_dot_program__pb2._PROGRAM
...
_CALIBRATIONLAYERRESULT.fields_by_name[
    'metrics'
].message_type = cirq__google_dot_api_dot_v2_dot_metrics__pb2._METRICSSNAPSHOT
...
FocusedCalibration = _reflection.GeneratedProtocolMessageType(
    'FocusedCalibration',
    (_message.Message,),
    {
...
CalibrationLayer = _reflection.GeneratedProtocolMessageType(
    'CalibrationLayer',
    (_message.Message,),
    {
...
FocusedCalibrationResult = _reflection.GeneratedProtocolMessageType(
...
CalibrationLayerResult = _reflection.GeneratedProtocolMessageType(
