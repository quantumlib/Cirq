...
class Moment(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["circuit_operations", b"circuit_operations", "moment_constant_index", b"moment_constant_index", "operations", b"operations"]) -> None: ...
