...
class Constant(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["circuit_value", b"circuit_value", "const_value", b"const_value", "moment_value", b"moment_value", "qubit", b"qubit", "string_value", b"string_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["circuit_value", b"circuit_value", "const_value", b"const_value", "moment_value", b"moment_value", "qubit", b"qubit", "string_value", b"string_value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["const_value", b"const_value"]) -> typing_extensions.Literal["string_value", "circuit_value", "qubit", "moment_value"] | None: ...
...
class Moment(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["circuit_operations", b"circuit_operations", "moment_constant_index", b"moment_constant_index", "operations", b"operations"]) -> None: ...
...
class Operation(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["gate_value", b"gate_value"]) -> typing_extensions.Literal["xpowgate", "ypowgate", "zpowgate", "phasedxpowgate", "phasedxzgate", "czpowgate", "fsimgate", "iswappowgate", "measurementgate", "waitgate", "internalgate", "couplerpulsegate", "identitygate", "hpowgate", "singlequbitcliffordgate"] | None: ...
    @typing.overload
...
class DynamicalDecouplingTag(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_protocol", b"_protocol", "protocol", b"protocol"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_protocol", b"_protocol", "protocol", b"protocol"]) -> None: ...
...
class Tag(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["dynamical_decoupling", b"dynamical_decoupling", "tag", b"tag"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dynamical_decoupling", b"dynamical_decoupling", "tag", b"tag"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["tag", b"tag"]) -> typing_extensions.Literal["dynamical_decoupling"] | None: ...
...
class ArgValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["arg_value", b"arg_value", "bool_values", b"bool_values", "double_value", b"double_value", "double_values", b"double_values", "float_value", b"float_value", "int64_values", b"int64_values", "string_value", b"string_value", "string_values", b"string_values", "value_with_unit", b"value_with_unit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["arg_value", b"arg_value", "bool_values", b"bool_values", "double_value", b"double_value", "double_values", b"double_values", "float_value", b"float_value", "int64_values", b"int64_values", "string_value", b"string_value", "string_values", b"string_values", "value_with_unit", b"value_with_unit"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["arg_value", b"arg_value"]) -> typing_extensions.Literal["float_value", "bool_values", "string_value", "double_value", "int64_values", "double_values", "string_values", "value_with_unit"] | None: ...
...
class FunctionInterpolation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["x_values", b"x_values", "y_values", b"y_values"]) -> None: ...
...
class CustomArg(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["custom_arg", b"custom_arg", "function_interpolation_data", b"function_interpolation_data"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["custom_arg", b"custom_arg", "function_interpolation_data", b"function_interpolation_data"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["custom_arg", b"custom_arg"]) -> typing_extensions.Literal["function_interpolation_data"] | None: ...
...
class InternalGate(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["custom_args", b"custom_args", "gate_args", b"gate_args", "module", b"module", "name", b"name", "num_qubits", b"num_qubits"]) -> None: ...
...
class SingleQubitCliffordGate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["tableau", b"tableau"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["tableau", b"tableau"]) -> None: ...
...
class IdentityGate(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["qid_shape", b"qid_shape"]) -> None: ...
