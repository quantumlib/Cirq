...
class Program(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"program",b"program"]) -> typing_extensions.Literal["circuit","schedule"]: ...
...
class Constant(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"const_value",b"const_value"]) -> typing_extensions.Literal["string_value","circuit_value","qubit"]: ...
global___Constant = Constant

class Circuit(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class SchedulingStrategy(metaclass=_SchedulingStrategy):
        V = typing.NewType('V', builtins.int)

    SCHEDULING_STRATEGY_UNSPECIFIED = Circuit.SchedulingStrategy.V(0)
    MOMENT_BY_MOMENT = Circuit.SchedulingStrategy.V(1)

    class _SchedulingStrategy(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[SchedulingStrategy.V], builtins.type):
...
class FloatArg(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"arg",b"arg"]) -> typing_extensions.Literal["float_value","symbol","func"]: ...
...
class Operation(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"gate_value",b"gate_value"]) -> typing_extensions.Literal["xpowgate","ypowgate","zpowgate","phasedxpowgate","phasedxzgate","czpowgate","fsimgate","iswappowgate","measurementgate","waitgate"]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"token",b"token"]) -> typing_extensions.Literal["token_value","token_constant_index"]: ...
...
class Arg(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"arg",b"arg"]) -> typing_extensions.Literal["arg_value","symbol","func","constant_index"]: ...
global___Arg = Arg
...
class ArgValue(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"arg_value",b"arg_value"]) -> typing_extensions.Literal["float_value","bool_values","string_value","double_value"]: ...
...
class RepetitionSpecification(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"repetition_value",b"repetition_value"]) -> typing_extensions.Literal["repetition_ids","repetition_count"]: ...
