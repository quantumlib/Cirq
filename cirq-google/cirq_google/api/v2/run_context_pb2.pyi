...
class Metadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_as_parameter", b"_as_parameter", "_label", b"_label", "as_parameter", b"as_parameter", "label", b"label"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_as_parameter", b"_as_parameter", "_label", b"_label", "as_parameter", b"as_parameter", "device_parameters", b"device_parameters", "label", b"label"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_as_parameter", b"_as_parameter"]) -> typing_extensions.Literal["as_parameter"] | None: ...
    @typing.overload
...
class SingleSweep(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["const_value", b"const_value", "linspace", b"linspace", "metadata", b"metadata", "parameter", b"parameter", "points", b"points", "sweep", b"sweep"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["const_value", b"const_value", "linspace", b"linspace", "metadata", b"metadata", "parameter", b"parameter", "parameter_key", b"parameter_key", "points", b"points", "sweep", b"sweep"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["sweep", b"sweep"]) -> typing_extensions.Literal["points", "linspace", "const_value"] | None: ...
...
class Points(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["points", b"points", "unit", b"unit"]) -> None: ...
...
class Linspace(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["unit", b"unit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["first_point", b"first_point", "last_point", b"last_point", "num_points", b"num_points", "unit", b"unit"]) -> None: ...
...
class ConstValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["float_value", b"float_value", "int_value", b"int_value", "is_none", b"is_none", "string_value", b"string_value", "value", b"value", "with_unit_value", b"with_unit_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["float_value", b"float_value", "int_value", b"int_value", "is_none", b"is_none", "string_value", b"string_value", "value", b"value", "with_unit_value", b"with_unit_value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["is_none", "float_value", "int_value", "string_value", "with_unit_value"] | None: ...
