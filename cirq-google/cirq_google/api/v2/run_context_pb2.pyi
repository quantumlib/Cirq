...
class RunContext(google___protobuf___message___Message):
    ...
    def __init__(
        self, parameter_sweeps: typing___Optional[typing___Iterable[ParameterSweep]] = None
    ) -> None: ...
    @classmethod
...
class ParameterSweep(google___protobuf___message___Message):
    ...
    def __init__(
        self, repetitions: typing___Optional[int] = None, sweep: typing___Optional[Sweep] = None
    ) -> None: ...
    @classmethod
...
class Sweep(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(
            self,
            field_name: typing_extensions___Literal[u"single_sweep", u"sweep", u"sweep_function"],
        ) -> bool: ...
        def ClearField(
            self,
            field_name: typing_extensions___Literal[u"single_sweep", u"sweep", u"sweep_function"],
        ...
        def ClearField(
            self,
            field_name: typing_extensions___Literal[b"single_sweep", b"sweep", b"sweep_function"],
        ) -> None: ...

    def WhichOneof(
        self, oneof_group: typing_extensions___Literal[u"sweep", b"sweep"]
    ) -> typing_extensions___Literal["sweep_function", "single_sweep"]: ...
...
class SweepFunction(google___protobuf___message___Message):
    ...
    def sweeps(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Sweep]: ...
    def __init__(
        self,
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"function_type", u"sweeps"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"function_type", b"sweeps"]
        ) -> None: ...
