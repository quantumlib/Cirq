...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_DEVICESPECIFICATION'].fields_by_name['valid_gate_sets']._options = None
  _globals['_DEVICESPECIFICATION'].fields_by_name['valid_gate_sets']._serialized_options = b'\030\001'
  _globals['_TARGETSET_TARGETORDERING'].values_by_name["ASYMMETRIC"]._options = None
  _globals['_TARGETSET_TARGETORDERING'].values_by_name["ASYMMETRIC"]._serialized_options = b'\010\001'
  _globals['_TARGETSET_TARGETORDERING'].values_by_name["SUBSET_PERMUTATION"]._options = None
