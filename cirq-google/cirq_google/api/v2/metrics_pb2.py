...
_METRICSSNAPSHOT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='timestamp_ms',
            full_name='cirq.google.api.v2.MetricsSnapshot.timestamp_ms',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='metrics',
            full_name='cirq.google.api.v2.MetricsSnapshot.metrics',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_METRIC = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='cirq.google.api.v2.Metric.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='targets',
            full_name='cirq.google.api.v2.Metric.targets',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='values',
            full_name='cirq.google.api.v2.Metric.values',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_VALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='double_val',
            full_name='cirq.google.api.v2.Value.double_val',
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='int32_val',
            full_name='cirq.google.api.v2.Value.int32_val',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='int64_val',
            full_name='cirq.google.api.v2.Value.int64_val',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='str_val',
            full_name='cirq.google.api.v2.Value.str_val',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name='val',
            full_name='cirq.google.api.v2.Value.val',
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_VALUE.oneofs_by_name['val'].fields.append(_VALUE.fields_by_name['double_val'])
_VALUE.fields_by_name['double_val'].containing_oneof = _VALUE.oneofs_by_name['val']
_VALUE.oneofs_by_name['val'].fields.append(_VALUE.fields_by_name['int32_val'])
_VALUE.fields_by_name['int32_val'].containing_oneof = _VALUE.oneofs_by_name['val']
_VALUE.oneofs_by_name['val'].fields.append(_VALUE.fields_by_name['int64_val'])
_VALUE.fields_by_name['int64_val'].containing_oneof = _VALUE.oneofs_by_name['val']
_VALUE.oneofs_by_name['val'].fields.append(_VALUE.fields_by_name['str_val'])
...
MetricsSnapshot = _reflection.GeneratedProtocolMessageType(
    'MetricsSnapshot',
    (_message.Message,),
    {
