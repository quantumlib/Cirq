...
class FocusedCalibration(google___protobuf___message___Message):
    ...
    def __init__(
        self, layers: typing___Optional[typing___Iterable[CalibrationLayer]] = None
    ) -> None: ...
    @classmethod
...
class CalibrationLayer(google___protobuf___message___Message):
    ...
    def args(
        self,
    ) -> typing___MutableMapping[typing___Text, cirq_google___api___v2___program_pb2___Arg]: ...
    def __init__(
        self,
        ...
        args: typing___Optional[
            typing___Mapping[typing___Text, cirq_google___api___v2___program_pb2___Arg]
        ] = None,
    ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(
            self, field_name: typing_extensions___Literal[u"args", u"calibration_type", u"layer"]
        ) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"layer", b"layer"]) -> bool: ...
        def ClearField(
            self, field_name: typing_extensions___Literal[b"args", b"calibration_type", b"layer"]
        ) -> None: ...
...
class FocusedCalibrationResult(google___protobuf___message___Message):
    ...
    def __init__(
        self, results: typing___Optional[typing___Iterable[CalibrationLayerResult]] = None
    ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(
            ...
            field_name: typing_extensions___Literal[
                u"code", u"error_message", u"metrics", u"token", u"valid_until_ms"
            ],
        ) -> None: ...
    else:
        def HasField(
            self, field_name: typing_extensions___Literal[u"metrics", b"metrics"]
        ) -> bool: ...
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"code", b"error_message", b"metrics", b"token", b"valid_until_ms"
            ],
        ) -> None: ...
