...
class MetricsSnapshot(google___protobuf___message___Message):
    ...
    def metrics(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Metric]: ...
    def __init__(
        self,
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"metrics", u"timestamp_ms"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"metrics", b"timestamp_ms"]
        ) -> None: ...
...
class Metric(google___protobuf___message___Message):
    ...
    def values(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Value]: ...
    def __init__(
        self,
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"name", u"targets", u"values"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"name", b"targets", b"values"]
        ) -> None: ...
    ...
    if sys.version_info >= (3,):
        def HasField(
            ...
            field_name: typing_extensions___Literal[
                u"double_val", u"int32_val", u"int64_val", u"str_val", u"val"
            ],
        ) -> bool: ...
        def ClearField(
            self,
        ...
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"double_val", b"int32_val", b"int64_val", b"str_val", b"val"
            ],
        ) -> None: ...

    def WhichOneof(
        self, oneof_group: typing_extensions___Literal[u"val", b"val"]
    ) -> typing_extensions___Literal["double_val", "int32_val", "int64_val", "str_val"]: ...
