...
DESCRIPTOR = _descriptor.FileDescriptor(
    name='cirq_google/api/v2/batch.proto',
    ...
    dependencies=[
        ...
        cirq__google_dot_api_dot_v2_dot_result__pb2.DESCRIPTOR,
        cirq__google_dot_api_dot_v2_dot_run__context__pb2.DESCRIPTOR,
    ],
)
...
_BATCHPROGRAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='programs',
            full_name='cirq.google.api.v2.BatchProgram.programs',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_BATCHRUNCONTEXT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='run_contexts',
            full_name='cirq.google.api.v2.BatchRunContext.run_contexts',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_BATCHRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='results',
            full_name='cirq.google.api.v2.BatchResult.results',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_BATCHPROGRAM.fields_by_name[
    'programs'
].message_type = cirq__google_dot_api_dot_v2_dot_program__pb2._PROGRAM
_BATCHRUNCONTEXT.fields_by_name[
    'run_contexts'
].message_type = cirq__google_dot_api_dot_v2_dot_run__context__pb2._RUNCONTEXT
_BATCHRESULT.fields_by_name[
    'results'
].message_type = cirq__google_dot_api_dot_v2_dot_result__pb2._RESULT
...
BatchProgram = _reflection.GeneratedProtocolMessageType(
    'BatchProgram',
    (_message.Message,),
    {
...
BatchRunContext = _reflection.GeneratedProtocolMessageType(
    'BatchRunContext',
    (_message.Message,),
    {
...
BatchResult = _reflection.GeneratedProtocolMessageType(
    'BatchResult',
    (_message.Message,),
    {
