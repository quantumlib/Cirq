...
class DeviceSpecification(google___protobuf___message___Message):
    ...
    def valid_gate_sets(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[GateSet]: ...
    @property
    def valid_gates(
        self,
    ...
    def valid_targets(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[TargetSet]: ...
    def __init__(
        self,
...
class GateSpecification(google___protobuf___message___Message):
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions___Literal[u"gate", b"gate"]
...
class GateSet(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"name", u"valid_gates"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"name", b"valid_gates"]
        ) -> None: ...
...
class GateDefinition(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                u"gate_duration_picos", u"id", u"number_of_qubits", u"valid_args", u"valid_targets"
            ],
        ) -> None: ...
    else:
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"gate_duration_picos", b"id", b"number_of_qubits", b"valid_args", b"valid_targets"
            ],
        ) -> None: ...
...
class ArgDefinition(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"allowed_ranges", u"name", u"type"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"allowed_ranges", b"name", b"type"]
        ) -> None: ...
...
class ArgumentRange(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"maximum_value", u"minimum_value"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"maximum_value", b"minimum_value"]
        ) -> None: ...
...
class TargetSet(google___protobuf___message___Message):
    ...
    def targets(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Target]: ...
    def __init__(
        self,
        name: typing___Optional[typing___Text] = None,
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"name", u"target_ordering", u"targets"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"name", b"target_ordering", b"targets"]
        ) -> None: ...
...
class Target(google___protobuf___message___Message):
    ...
    def __init__(self, ids: typing___Optional[typing___Iterable[typing___Text]] = None) -> None: ...
    @classmethod
