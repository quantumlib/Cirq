...
_RESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='sweep_results',
            full_name='cirq.google.api.v2.Result.sweep_results',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SWEEPRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='repetitions',
            full_name='cirq.google.api.v2.SweepResult.repetitions',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.google.api.v2.SweepResult.parameterized_results',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PARAMETERIZEDRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='params',
            full_name='cirq.google.api.v2.ParameterizedResult.params',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.google.api.v2.ParameterizedResult.measurement_results',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_MEASUREMENTRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='cirq.google.api.v2.MeasurementResult.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='instances',
            full_name='cirq.google.api.v2.MeasurementResult.instances',
            index=1,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='qubit_measurement_results',
            full_name='cirq.google.api.v2.MeasurementResult.qubit_measurement_results',
            index=2,
            number=2,
            type=11,
            cpp_type=10,
...
_QUBITMEASUREMENTRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='qubit',
            full_name='cirq.google.api.v2.QubitMeasurementResult.qubit',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='results',
            full_name='cirq.google.api.v2.QubitMeasurementResult.results',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_PARAMETERDICT_ASSIGNMENTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='cirq.google.api.v2.ParameterDict.AssignmentsEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='cirq.google.api.v2.ParameterDict.AssignmentsEntry.value',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_PARAMETERDICT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='assignments',
            full_name='cirq.google.api.v2.ParameterDict.assignments',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_MEASUREMENTRESULT.fields_by_name[
    'qubit_measurement_results'
].message_type = _QUBITMEASUREMENTRESULT
_QUBITMEASUREMENTRESULT.fields_by_name[
    'qubit'
].message_type = cirq__google_dot_api_dot_v2_dot_program__pb2._QUBIT
...
MeasurementResult = _reflection.GeneratedProtocolMessageType(
    'MeasurementResult',
    (_message.Message,),
    {
...
QubitMeasurementResult = _reflection.GeneratedProtocolMessageType(
