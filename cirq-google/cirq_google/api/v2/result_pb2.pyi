...
import sys
from cirq_google.api.v2.program_pb2 import Qubit as cirq_google___api___v2___program_pb2___Qubit
...
class SweepResult(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(
            self, field_name: typing_extensions___Literal[u"parameterized_results", u"repetitions"]
        ) -> None: ...
    else:
        def ClearField(
            self, field_name: typing_extensions___Literal[b"parameterized_results", b"repetitions"]
        ) -> None: ...
...
class MeasurementResult(google___protobuf___message___Message):
    ...
    def __init__(
        ...
        qubit_measurement_results: typing___Optional[
            typing___Iterable[QubitMeasurementResult]
        ] = None,
    ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        def ClearField(
            ...
            field_name: typing_extensions___Literal[
                u"instances", u"key", u"qubit_measurement_results"
            ],
        ) -> None: ...
    else:
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
                b"instances", b"key", b"qubit_measurement_results"
            ],
        ) -> None: ...
...
class QubitMeasurementResult(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(
            self, field_name: typing_extensions___Literal[u"qubit", u"results"]
        ) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"qubit", b"qubit"]) -> bool: ...
        def ClearField(
            self, field_name: typing_extensions___Literal[b"qubit", b"results"]
        ) -> None: ...
