...
class QuantumEngineServiceClient(metaclass=QuantumEngineServiceClientMeta):
    ...
    def _compare_universes(client_universe: str,
        ...
        default_universe = QuantumEngineServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            QuantumEngineServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
