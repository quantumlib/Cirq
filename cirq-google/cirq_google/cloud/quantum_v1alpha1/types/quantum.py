...
class QuantumJob(proto.Message):
    ...
    run_context: any_pb2.Any = proto.Field(
        proto.MESSAGE,
        number=11,
        message=any_pb2.Any,
    )
...
class SchedulingConfig(proto.Message):
    ...
    class ProcessorSelector(proto.Message):
        ...
        processor_names: MutableSequence[str] = proto.RepeatedField(
            proto.STRING,
            number=1,
        )
...
class ExecutionStatus(proto.Message):
    ...
    calibration_name: str = proto.Field(
        proto.STRING,
        number=4,
    )
    failure: Failure = proto.Field(
        proto.MESSAGE,
        number=5,
        message=Failure,
    )
    timing: Timing = proto.Field(
        proto.MESSAGE,
        number=6,
        message=Timing,
    )
...
class DeviceConfigSelector(proto.Message):
    ...
    run_name: str = proto.Field(
        proto.STRING,
        number=1,
        oneof='top_level_identifier',
    )
...
class OutputConfig(proto.Message):
    ...
    overwrite_existing: bool = proto.Field(
        proto.BOOL,
        number=2,
    )
...
class QuantumResult(proto.Message):
    ...
    result: any_pb2.Any = proto.Field(
        proto.MESSAGE,
        number=2,
        message=any_pb2.Any,
    )
...
class QuantumProcessor(proto.Message):
    ...
    class ActivityStats(proto.Message):
        ...
        active_users_count: int = proto.Field(
            proto.INT64,
            number=1,
        )
        active_jobs_count: int = proto.Field(
            proto.INT64,
            number=2,
        )
    ...
    supported_languages: MutableSequence[str] = proto.RepeatedField(
        proto.STRING,
        number=5,
    )
    device_spec: any_pb2.Any = proto.Field(
        proto.MESSAGE,
        number=6,
        message=any_pb2.Any,
    )
    ...
    current_calibration: str = proto.Field(
        proto.STRING,
        number=10,
    )
    ...
    activity_stats: ActivityStats = proto.Field(
        proto.MESSAGE,
        number=12,
...
class QuantumProcessorConfig(proto.Message):
    ...
    device_specification: any_pb2.Any = proto.Field(
        proto.MESSAGE,
        number=2,
        message=any_pb2.Any,
    )
    characterization: any_pb2.Any = proto.Field(
        proto.MESSAGE,
        number=3,
        message=any_pb2.Any,
    )
...
class QuantumReservationGrant(proto.Message):
    ...
    budgets: MutableSequence[Budget] = proto.RepeatedField(
        proto.MESSAGE,
        number=7,
        message=Budget,
    )
...
class QuantumTimeSlot(proto.Message):
    ...
    class ReservationConfig(proto.Message):
        ...
        allowlisted_users: MutableSequence[str] = proto.RepeatedField(
            proto.STRING,
            number=2,
        )
    ...
    time_slot_type: TimeSlotType = proto.Field(
        proto.ENUM,
        number=5,
        enum=TimeSlotType,
    )
