...
@cirq.value_equality
class GoogleGridDevice(cirq.Device):
    """Device object representing Google devices with a grid qubit layout.
    ...
    This class is compliant with the core `cirq.Device` abstraction. In particular:
        ...
        * An instance of `GoogleGridDevice` can be used to validate circuits, moments, and
          operations.
    ...
    CompilationTargetGatesets generated by GoogleGridDevice. To better control circuit timing,
    insert WaitGates after the circuit has been transformed.
    ...
    def __init__(self, metadata: cirq.GridDeviceMetadata):
        """Creates a GoogleGridDevice object.
    ...
    @classmethod
    def from_proto(cls, proto: v2.device_pb2.DeviceSpecification) -> 'GoogleGridDevice':
        """Create a `GoogleGridDevice` from a `DeviceSpecification` proto.
        ...
        return GoogleGridDevice(metadata)
    ...
    def __repr__(self) -> str:
        return f'cirq_google.GoogleGridDevice({repr(self._metadata)})'
