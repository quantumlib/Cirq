...
def test_to_quantum_processor_selector(project_id: str, processor_id: str, config_key: cg.DeviceConfigKey):
  ...
  if selector.config_key:
      assert quantum_selector.device_config_key == selector.config_key.to_quantum_device_config_key()
  else:
