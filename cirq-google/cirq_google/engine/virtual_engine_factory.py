...
MEDIAN_CALIBRATIONS = {
    ...
    'weber': 'weber_2021_03_11_calibration.json',
}

MEDIAN_CALIBRATION_TIMESTAMPS = {'rainbow': 1635845358175, 'weber': 1635923188204}
...
def load_median_device_calibration(processor_id: str) -> calibration.Calibration:
    """Loads a median Calibration for the given device.
