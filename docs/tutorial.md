...
# (0, 0): ───X^1/10───────────@───────X───────────────────────────────@───────X───────────────────────────────
#                             │                                       │
# (0, 1): ───X^1/10───Z^1/5───┼───────@───────────────────────X───────@^3/10──X───X───────@───────X───────────
#                             │       │                                                   │
# (0, 2): ───X^1/10───Z^1/5───┼───────┼───────@───────────────X───────────────────────────@^3/10──X───────────
#                             │       │       │
# (1, 0): ───X^1/10───────────@^3/10──┼───────┼───────@───────X───────────────────────────@───────X───────────
#                                     │       │       │                                   │
# (1, 1): ───X^1/10───Z^1/5───────────@^3/10──┼───────┼───────X───────@───────X───X───────@^3/10──X───@───────
#                                             │       │               │                               │
# (1, 2): ───X^1/10───Z^1/5───────────────────@^3/10──┼───────@───────┼───────────────────────────────@^3/10──
#                                                     │       │       │
# (2, 0): ───X^1/10───────────────────────────────────@^3/10──┼───────┼───────────@───────────────────────────
#                                                             │       │           │
# (2, 1): ───X^1/10───Z^1/5───────────X───────────────────────┼───────@^3/10──X───@^3/10──@───────────────────
#                                                             │                           │
# (2, 2): ───X^1/10───Z^1/5───────────────────────────────────@^3/10──────────────────────@^3/10──────────────
```
