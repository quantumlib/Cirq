...
<meta itemprop="name" content="cirq.ops.PhaseFlipChannel" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.PhaseFlipChannel`, `cirq.ops.common_channels.PhaseFlipChannel`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.PhaseFlipChannel(
    p: float
) -> None
</code></pre>
