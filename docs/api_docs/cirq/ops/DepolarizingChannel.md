...
<meta itemprop="name" content="cirq.ops.DepolarizingChannel" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.DepolarizingChannel`, `cirq.ops.common_channels.DepolarizingChannel`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.DepolarizingChannel(
    p: float
) -> None
</code></pre>
