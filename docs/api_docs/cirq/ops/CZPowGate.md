...
<meta itemprop="name" content="cirq.ops.CZPowGate" />
...
Inherits From: [`EigenGate`](../../cirq/ops/EigenGate.md), [`TwoQubitGate`](../../cirq/ops/TwoQubitGate.md), [`InterchangeableQubitsGate`](../../cirq/ops/InterchangeableQubitsGate.md)

<section class="expandable">
  <h4 class="showalways">View aliases</h4>
  <p>
<b>Main aliases</b>
<p>`cirq.CZPowGate`, `cirq.ops.common_gates.CZPowGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.CZPowGate(
    *,
