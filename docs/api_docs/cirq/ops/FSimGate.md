...
<meta itemprop="name" content="cirq.ops.FSimGate" />
...
Inherits From: [`TwoQubitGate`](../../cirq/ops/TwoQubitGate.md), [`InterchangeableQubitsGate`](../../cirq/ops/InterchangeableQubitsGate.md)

<section class="expandable">
  <h4 class="showalways">View aliases</h4>
  <p>
<b>Main aliases</b>
<p>`cirq.FSimGate`, `cirq.ops.fsim_gate.FSimGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.FSimGate(
    theta: float,
    phi: float
) -> None
</code></pre>
...
<a target="_blank" href="https://github.com/quantumlib/cirq/tree/master/cirq/ops/fsim_gate.py">View source</a>
