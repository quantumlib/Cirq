...
<meta itemprop="name" content="cirq.ops.PhaseDampingChannel" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.PhaseDampingChannel`, `cirq.ops.common_channels.PhaseDampingChannel`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.PhaseDampingChannel(
    gamma: float
) -> None
</code></pre>
