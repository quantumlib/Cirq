...
<meta itemprop="name" content="cirq.ops.CNotPowGate" />
...
Inherits From: [`EigenGate`](../../cirq/ops/EigenGate.md), [`TwoQubitGate`](../../cirq/ops/TwoQubitGate.md)

<section class="expandable">
  <h4 class="showalways">View aliases</h4>
  <p>
<b>Main aliases</b>
<p>`cirq.CNotPowGate`, `cirq.CXPowGate`, `cirq.ops.CXPowGate`, `cirq.ops.common_gates.CNotPowGate`, `cirq.ops.common_gates.CXPowGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.CNotPowGate(
    *,
