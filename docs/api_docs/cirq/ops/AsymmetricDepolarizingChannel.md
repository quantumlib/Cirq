...
<meta itemprop="name" content="cirq.ops.AsymmetricDepolarizingChannel" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.AsymmetricDepolarizingChannel`, `cirq.ops.common_channels.AsymmetricDepolarizingChannel`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.AsymmetricDepolarizingChannel(
    p_x: float,
    p_y: float,
    p_z: float
) -> None
...
<td>
if the args or the sum of args are not probabilities.
</td>
</tr>
</table>
