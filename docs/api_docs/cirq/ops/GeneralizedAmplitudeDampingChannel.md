...
<meta itemprop="name" content="cirq.ops.GeneralizedAmplitudeDampingChannel" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.GeneralizedAmplitudeDampingChannel`, `cirq.ops.common_channels.GeneralizedAmplitudeDampingChannel`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.GeneralizedAmplitudeDampingChannel(
    p: float,
    gamma: float
) -> None
</code></pre>
...
<td>
if gamma or p is not a valid probability.
</td>
</tr>
</table>
