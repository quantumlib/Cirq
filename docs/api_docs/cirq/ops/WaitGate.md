...
<meta itemprop="name" content="cirq.ops.WaitGate" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.WaitGate`, `cirq.ops.wait_gate.WaitGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.WaitGate(
...
<td>
A constant or parameterized wait duration. This can be
an instance of `datetime.timedelta` or <a href="../../cirq/value/Duration.md"><code>cirq.Duration</code></a>.
</td>
</tr>
</table>
...
<a target="_blank" href="https://github.com/quantumlib/cirq/tree/master/cirq/ops/wait_gate.py">View source</a>
