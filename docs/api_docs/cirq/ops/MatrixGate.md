...
<meta itemprop="name" content="cirq.ops.MatrixGate" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.MatrixGate`, `cirq.ops.matrix_gates.MatrixGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.MatrixGate(
    matrix: np.ndarray,
    *,
...
<td>
The shape of state tensor that the matrix applies to.
...
<a target="_blank" href="https://github.com/quantumlib/cirq/tree/master/cirq/ops/matrix_gates.py">View source</a>
