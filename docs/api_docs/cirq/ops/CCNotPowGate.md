...
<meta itemprop="name" content="cirq.ops.CCNotPowGate" />
...
Inherits From: [`EigenGate`](../../cirq/ops/EigenGate.md), [`ThreeQubitGate`](../../cirq/ops/ThreeQubitGate.md), [`InterchangeableQubitsGate`](../../cirq/ops/InterchangeableQubitsGate.md)

<section class="expandable">
  <h4 class="showalways">View aliases</h4>
  <p>
<b>Main aliases</b>
<p>`cirq.CCNotPowGate`, `cirq.CCXPowGate`, `cirq.ops.CCXPowGate`, `cirq.ops.three_qubit_gates.CCNotPowGate`, `cirq.ops.three_qubit_gates.CCXPowGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.CCNotPowGate(
    *,
...
<a target="_blank" href="https://github.com/quantumlib/cirq/tree/master/cirq/ops/three_qubit_gates.py">View source</a>
