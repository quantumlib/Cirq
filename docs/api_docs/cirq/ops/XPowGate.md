...
<meta itemprop="name" content="cirq.ops.XPowGate" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.XPowGate`, `cirq.ops.common_gates.XPowGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.XPowGate(
    *,
...
about the Pauli X axis. See <a href="../../cirq/ops/rx.md"><code>cirq.rx</code></a> for rotations without the global
phase. The global phase factor can be adjusted by using the `global_shift`
parameter when initializing.

<a href="../../cirq/ops/X.md"><code>cirq.X</code></a>, the Pauli X gate, is an instance of this gate at exponent=1.
...
<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>with_canonical_global_phase() -> "XPowGate"
</code></pre>
