...
<meta itemprop="name" content="cirq.ops.ResetChannel" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.ResetChannel`, `cirq.ops.common_channels.ResetChannel`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.ops.ResetChannel(
    dimension: int = 2
) -> None
</code></pre>
...
<td>
Specify this argument when resetting a qudit.  There will
