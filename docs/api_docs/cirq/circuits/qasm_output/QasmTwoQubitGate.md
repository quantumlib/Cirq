...
<meta itemprop="name" content="cirq.circuits.qasm_output.QasmTwoQubitGate" />
...
<code>cirq.circuits.qasm_output.QasmTwoQubitGate(
    kak: <a href="../../../cirq/linalg/KakDecomposition.md"><code>cirq.linalg.KakDecomposition</code></a>
) -> None
</code></pre>
...
<td>
KAK decomposition of the two-qubit gate.
</td>
</tr>
</table>
...
<td>
The unitary matrix of the two qubit gate.
</td>
</tr><tr>
<td>
`atol`
...
<td>
Absolute error tolerance when decomposing.
</td>
</tr>
</table>
