...
<meta itemprop="name" content="cirq.interop.quirk.cells.input_cells.SetDefaultInputCell" />
...
# cirq.interop.quirk.cells.input_cells.SetDefaultInputCell
...
<code>cirq.interop.quirk.cells.input_cells.SetDefaultInputCell(
    letter: str,
    value: int
)
</code></pre>
