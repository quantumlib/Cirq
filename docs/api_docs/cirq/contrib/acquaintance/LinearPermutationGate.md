...
<meta itemprop="name" content="cirq.contrib.acquaintance.LinearPermutationGate" />
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`cirq.contrib.acquaintance.permutation.LinearPermutationGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.contrib.acquaintance.LinearPermutationGate(
    num_qubits: int,
...
<td>
The permutation effected by the gate.
</td>
</tr><tr>
<td>
`swap_gate`
...
<td>
The swap gate used in decompositions.
</td>
</tr>
</table>
