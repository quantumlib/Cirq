...
<meta itemprop="name" content="cirq.contrib.acquaintance.AcquaintanceOpportunityGate" />
...
Inherits From: [`Gate`](../../../cirq/ops/Gate.md), [`InterchangeableQubitsGate`](../../../cirq/ops/InterchangeableQubitsGate.md)

<section class="expandable">
  <h4 class="showalways">View aliases</h4>
  <p>
<b>Main aliases</b>
<p>`cirq.contrib.acquaintance.gates.AcquaintanceOpportunityGate`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>cirq.contrib.acquaintance.AcquaintanceOpportunityGate(
    num_qubits: int
)
</code></pre>
