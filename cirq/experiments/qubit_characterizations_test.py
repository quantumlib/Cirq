...
def test_single_qubit_state_tomography():
    ...
    act_rho_1 = single_qubit_state_tomography(qubit, circuit_1, 10000, False)
    act_rho_2 = single_qubit_state_tomography(qubit, circuit_2, 10000, False)
    act_rho_3 = single_qubit_state_tomography(qubit, circuit_3, 10000, False)
...
def test_two_qubit_state_tomography():
    ...
    act_rho_00 = two_qubit_state_tomography(q_0, q_1, circuit_00, 10000, False)
    act_rho_01 = two_qubit_state_tomography(q_0, q_1, circuit_01, 10000, False)
    act_rho_10 = two_qubit_state_tomography(q_0, q_1, circuit_10, 10000, False)
    act_rho_11 = two_qubit_state_tomography(q_0, q_1, circuit_11, 10000, False)
