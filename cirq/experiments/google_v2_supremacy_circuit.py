...
def generate_google_presupremacy_circuit_v2(qubits: Iterable[devices.GridQubit],
                                            cz_depth: int,
...
def generate_google_presupremacy_circuit_v2_grid(n_rows: int, n_cols: int,
                                                 cz_depth: int,
                                                 seed: int) -> circuits.Circuit:
    """
    Generates Google Random Circuits v2 as in github.com/sboixo/GRCS cz_v2.
    ...
    return generate_google_presupremacy_circuit_v2(qubits, cz_depth, seed)


def generate_google_presupremacy_circuit_v2_bristlecone(n_rows: int,
