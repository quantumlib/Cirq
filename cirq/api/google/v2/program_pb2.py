...
_ARG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='number', full_name='cirq.api.google.v2.Arg.number', index=0,
...
_ARG.oneofs_by_name['arg'].fields.append(
  _ARG.fields_by_name['number'])
_ARG.fields_by_name['number'].containing_oneof = _ARG.oneofs_by_name['arg']
_ARG.oneofs_by_name['arg'].fields.append(
