...
class Program(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"circuit",b"circuit",u"language",b"language",u"program",b"program",u"schedule",b"schedule"]) -> None: ...
...
class Circuit(google___protobuf___message___Message):
    ...
    class SchedulingStrategy(int):
        ...
        SCHEDULING_STRATEGY_UNSPECIFIED = typing___cast(Circuit.SchedulingStrategy, 0)
        MOMENT_BY_MOMENT = typing___cast(Circuit.SchedulingStrategy, 1)
    SCHEDULING_STRATEGY_UNSPECIFIED = typing___cast(Circuit.SchedulingStrategy, 0)
    MOMENT_BY_MOMENT = typing___cast(Circuit.SchedulingStrategy, 1)
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"moments",b"moments",u"scheduling_strategy",b"scheduling_strategy"]) -> None: ...
...
class Moment(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"operations",b"operations"]) -> None: ...
...
class Schedule(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"scheduled_operations",b"scheduled_operations"]) -> None: ...
...
class ScheduledOperation(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"operation",b"operation",u"start_time_picos",b"start_time_picos"]) -> None: ...
...
class Language(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"arg_function_language",b"arg_function_language",u"gate_set",b"gate_set"]) -> None: ...
...
class Operation(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"args",b"args",u"gate",b"gate",u"qubits",b"qubits"]) -> None: ...
...
class Arg(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"arg",b"arg",u"arg_value",b"arg_value",u"func",b"func",u"symbol",b"symbol"]) -> None: ...
...
class ArgValue(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"arg_value",b"arg_value",u"bool_values",b"bool_values",u"float_value",b"float_value",u"string_value",b"string_value"]) -> None: ...
