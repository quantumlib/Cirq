...
class DeviceSpecification(google.protobuf.message.Message):
    ...
    @property
    def valid_targets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[TargetList]: ...
    ...
    def __init__(self,
        ...
        valid_targets : typing.Optional[typing.Iterable[TargetList]] = None,
...
class TargetList(google.protobuf.message.Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> TargetList: ...
    def MergeFrom(self, other_msg: google.protobuf.message.Message) -> None: ...
    def CopyFrom(self, other_msg: google.protobuf.message.Message) -> None: ...
