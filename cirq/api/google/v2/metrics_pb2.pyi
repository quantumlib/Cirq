...
class MetricsSnapshot(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metrics",b"metrics",u"timestamp_ms",b"timestamp_ms"]) -> None: ...
...
class Metric(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"name",b"name",u"targets",b"targets",u"values",b"values"]) -> None: ...
...
class Value(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"double_val",b"double_val",u"int32_val",b"int32_val",u"int64_val",b"int64_val",u"str_val",b"str_val",u"val",b"val"]) -> None: ...
