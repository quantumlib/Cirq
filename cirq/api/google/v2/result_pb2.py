...
# source: cirq/api/google/v2/result.proto
...
_RESULT = _descriptor.Descriptor(
  name='Result',
  full_name='cirq.api.google.v2.Result',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sweep_results', full_name='cirq.api.google.v2.Result.sweep_results', index=0,
...
_SWEEPRESULT = _descriptor.Descriptor(
  name='SweepResult',
  full_name='cirq.api.google.v2.SweepResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='repetitions', full_name='cirq.api.google.v2.SweepResult.repetitions', index=0,
...
_PARAMETERIZEDRESULT = _descriptor.Descriptor(
  ...
  full_name='cirq.api.google.v2.ParameterizedResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='params', full_name='cirq.api.google.v2.ParameterizedResult.params', index=0,
...
_PARAMETERDICT_ASSIGNMENTSENTRY = _descriptor.Descriptor(
  ...
  full_name='cirq.api.google.v2.ParameterDict.AssignmentsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='cirq.api.google.v2.ParameterDict.AssignmentsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='cirq.api.google.v2.ParameterDict.AssignmentsEntry.value', index=1,
...
_PARAMETERDICT = _descriptor.Descriptor(
  name='ParameterDict',
  full_name='cirq.api.google.v2.ParameterDict',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='assignments', full_name='cirq.api.google.v2.ParameterDict.assignments', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\035com.google.cirq.api.google.v2B\013ResultProtoP\001'))
