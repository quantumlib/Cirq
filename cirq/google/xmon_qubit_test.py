...
def test_xmon_qubit_eq():
    ...
    eq.make_equality_group(lambda: XmonQubit(0, 0))
    eq.make_equality_group(lambda: XmonQubit(1, 0))
    eq.make_equality_group(lambda: XmonQubit(0, 1))
    eq.make_equality_group(lambda: XmonQubit(50, 25))
