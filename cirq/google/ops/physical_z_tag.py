...
class PhysicalZTag:
  ...
  hardware that an actual physical operation should be done instead.  This
  class can only be applied to instances of `cirq.ZPowGate`.  If applied to
  other gates (such as PhasedXZGate), this class will have no effect.
  """
