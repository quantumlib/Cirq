...
_CALIBRATIONLAYER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='token', full_name='cirq.google.api.v2.CalibrationLayer.token', index=3,
...
_CALIBRATIONLAYER_ARGSENTRY.fields_by_name['value'].message_type = cirq_dot_google_dot_api_dot_v2_dot_program__pb2._ARG
