...
class CalibrationLayer(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"args",u"calibration_type",u"layer",u"token"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"layer",b"layer"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"args",b"calibration_type",b"layer",b"token"]) -> None: ...
