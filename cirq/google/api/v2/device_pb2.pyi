...
class DeviceSpecification(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"developer_recommendations",b"developer_recommendations",u"valid_gate_sets",b"valid_gate_sets",u"valid_qubits",b"valid_qubits",u"valid_targets",b"valid_targets"]) -> None: ...
...
class GateSet(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"name",b"name",u"valid_gates",b"valid_gates"]) -> None: ...
...
class GateDefinition(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"gate_duration_picos",b"gate_duration_picos",u"id",b"id",u"number_of_qubits",b"number_of_qubits",u"valid_args",b"valid_args",u"valid_targets",b"valid_targets"]) -> None: ...
...
class ArgDefinition(google___protobuf___message___Message):
    ...
    class ArgType(int):
        ...
        UNSPECIFIED = typing___cast(ArgDefinition.ArgType, 0)
        FLOAT = typing___cast(ArgDefinition.ArgType, 1)
        REPEATED_BOOLEAN = typing___cast(ArgDefinition.ArgType, 2)
        STRING = typing___cast(ArgDefinition.ArgType, 3)
    UNSPECIFIED = typing___cast(ArgDefinition.ArgType, 0)
    FLOAT = typing___cast(ArgDefinition.ArgType, 1)
    REPEATED_BOOLEAN = typing___cast(ArgDefinition.ArgType, 2)
    STRING = typing___cast(ArgDefinition.ArgType, 3)
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"allowed_ranges",b"allowed_ranges",u"name",b"name",u"type",b"type"]) -> None: ...
...
class ArgumentRange(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"maximum_value",b"maximum_value",u"minimum_value",b"minimum_value"]) -> None: ...
...
class TargetSet(google___protobuf___message___Message):
    ...
    class TargetOrdering(int):
        ...
        UNSPECIFIED = typing___cast(TargetSet.TargetOrdering, 0)
        SYMMETRIC = typing___cast(TargetSet.TargetOrdering, 1)
        ASYMMETRIC = typing___cast(TargetSet.TargetOrdering, 2)
        SUBSET_PERMUTATION = typing___cast(TargetSet.TargetOrdering, 3)
    UNSPECIFIED = typing___cast(TargetSet.TargetOrdering, 0)
    SYMMETRIC = typing___cast(TargetSet.TargetOrdering, 1)
    ASYMMETRIC = typing___cast(TargetSet.TargetOrdering, 2)
    SUBSET_PERMUTATION = typing___cast(TargetSet.TargetOrdering, 3)
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"name",b"name",u"target_ordering",b"target_ordering",u"targets",b"targets"]) -> None: ...
