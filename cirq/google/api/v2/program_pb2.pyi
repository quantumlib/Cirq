...
class MeasurementKeyMapping(google___protobuf___message___Message):
    ...
    @property
    def entries(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[MeasurementKey]: ...

    def __init__(self,
        entries : typing___Optional[typing___Iterable[MeasurementKey]] = None,
        ) -> None: ...
    @classmethod
