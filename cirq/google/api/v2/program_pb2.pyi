...
class BatchedProgram(google___protobuf___message___Message):

    @property
    def programs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Program]: ...

    def __init__(self,
        programs : typing___Optional[typing___Iterable[Program]] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> BatchedProgram: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
