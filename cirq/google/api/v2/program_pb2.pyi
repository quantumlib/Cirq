...
class Operation(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"arg",u"constant_index",u"gate",u"token_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"arg",u"args",u"constant_index",u"gate",u"qubits",u"token_value"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"arg",b"arg",u"constant_index",b"constant_index",u"gate",b"gate",u"token_value",b"token_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"arg",b"args",b"constant_index",b"gate",b"qubits",b"token_value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"arg",b"arg"]) -> typing_extensions___Literal["token_value","constant_index"]: ...
