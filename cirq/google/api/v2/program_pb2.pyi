...
class Constant(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"circuit_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"circuit_value",u"string_value"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"circuit_value",b"circuit_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"circuit_value",b"string_value"]) -> None: ...
