...
class Constant(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"circuit_value",u"const_value",u"string_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"circuit_value",u"const_value",u"string_value"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"circuit_value",b"circuit_value",u"const_value",b"const_value",u"string_value",b"string_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"circuit_value",b"const_value",b"string_value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"const_value",b"const_value"]) -> typing_extensions___Literal["string_value","circuit_value"]: ...
...
class Moment(google___protobuf___message___Message):
    ...
    @property
    def generic_operations(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[GenericOperation]: ...

    def __init__(self,
        operations : typing___Optional[typing___Iterable[Operation]] = None,
        generic_operations : typing___Optional[typing___Iterable[GenericOperation]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"generic_operations",u"operations"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"generic_operations",b"operations"]) -> None: ...
...
class GenericOperation(google___protobuf___message___Message):

    @property
    def operation(self) -> Operation: ...

    @property
    def circuit_operation(self) -> CircuitOperation: ...

    def __init__(self,
        operation : typing___Optional[Operation] = None,
        circuit_operation : typing___Optional[CircuitOperation] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> GenericOperation: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"circuit_operation",u"op",u"operation"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"circuit_operation",u"op",u"operation"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"circuit_operation",b"circuit_operation",u"op",b"op",u"operation",b"operation"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"circuit_operation",b"op",b"operation"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"op",b"op"]) -> typing_extensions___Literal["operation","circuit_operation"]: ...
...
class CircuitOperation(google___protobuf___message___Message):
    ...
    @property
    def repetition_spec(self) -> RepetitionSpec: ...
    ...
    def __init__(self,
        ...
        repetition_spec : typing___Optional[RepetitionSpec] = None,
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"arg_map",u"measurement_key_map",u"qubit_map",u"repetition_spec"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"arg_map",u"circuit_constant_index",u"measurement_key_map",u"qubit_map",u"repetition_spec"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"arg_map",b"arg_map",u"measurement_key_map",b"measurement_key_map",u"qubit_map",b"qubit_map",u"repetition_spec",b"repetition_spec"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"arg_map",b"circuit_constant_index",b"measurement_key_map",b"qubit_map",b"repetition_spec"]) -> None: ...

class RepetitionSpec(google___protobuf___message___Message):
    class RepetitionIds(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> RepetitionSpec.RepetitionIds: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
    ...
    @property
    def rep_ids(self) -> RepetitionSpec.RepetitionIds: ...

    def __init__(self,
        rep_ids : typing___Optional[RepetitionSpec.RepetitionIds] = None,
        rep_count : typing___Optional[int] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> RepetitionSpec: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"rep_count",u"rep_ids",u"rep_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"rep_count",u"rep_ids",u"rep_value"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"rep_count",b"rep_count",u"rep_ids",b"rep_ids",u"rep_value",b"rep_value"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"rep_count",b"rep_ids",b"rep_value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"rep_value",b"rep_value"]) -> typing_extensions___Literal["rep_ids","rep_count"]: ...

class QubitMapping(google___protobuf___message___Message):
    class QubitPair(google___protobuf___message___Message):

        @property
        def first(self) -> Qubit: ...

        @property
        def second(self) -> Qubit: ...

        def __init__(self,
            first : typing___Optional[Qubit] = None,
            second : typing___Optional[Qubit] = None,
            ) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> QubitMapping.QubitPair: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def HasField(self, field_name: typing_extensions___Literal[u"first",u"second"]) -> bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[u"first",u"second"]) -> None: ...
        else:
            def HasField(self, field_name: typing_extensions___Literal[u"first",b"first",u"second",b"second"]) -> bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[b"first",b"second"]) -> None: ...


    @property
    def qubit_pairs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[QubitMapping.QubitPair]: ...

    def __init__(self,
        qubit_pairs : typing___Optional[typing___Iterable[QubitMapping.QubitPair]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"qubit_pairs"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"qubit_pairs"]) -> None: ...

class MeasurementKey(google___protobuf___message___Message):
    str_key = ... # type: typing___Text

    def __init__(self,
        str_key : typing___Optional[typing___Text] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"str_key"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"str_key"]) -> None: ...

class MeasurementKeyMapping(google___protobuf___message___Message):
    class MeasurementKeyPair(google___protobuf___message___Message):

        @property
        def first(self) -> MeasurementKey: ...

        @property
        def second(self) -> MeasurementKey: ...

        def __init__(self,
            first : typing___Optional[MeasurementKey] = None,
            second : typing___Optional[MeasurementKey] = None,
            ) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> MeasurementKeyMapping.MeasurementKeyPair: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def HasField(self, field_name: typing_extensions___Literal[u"first",u"second"]) -> bool: ...
    ...
    @property
    def measurement_key_pairs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[MeasurementKeyMapping.MeasurementKeyPair]: ...

    def __init__(self,
        measurement_key_pairs : typing___Optional[typing___Iterable[MeasurementKeyMapping.MeasurementKeyPair]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"measurement_key_pairs"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"measurement_key_pairs"]) -> None: ...

class ArgMapping(google___protobuf___message___Message):
    class ArgPair(google___protobuf___message___Message):
        ...
        def __init__(self,
            first : typing___Optional[Arg] = None,
            second : typing___Optional[Arg] = None,
            ) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> ArgMapping.ArgPair: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def HasField(self, field_name: typing_extensions___Literal[u"first",u"second"]) -> bool: ...
    ...
    @property
    def arg_pairs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ArgMapping.ArgPair]: ...

    def __init__(self,
        arg_pairs : typing___Optional[typing___Iterable[ArgMapping.ArgPair]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"arg_pairs"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"arg_pairs"]) -> None: ...
