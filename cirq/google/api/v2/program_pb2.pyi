...
class QubitMapping(google___protobuf___message___Message):
    ...
    @property
    def pairs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[QubitMapping.QubitPair]: ...

    def __init__(self,
        pairs : typing___Optional[typing___Iterable[QubitMapping.QubitPair]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"pairs"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"pairs"]) -> None: ...
...
class MeasurementKeyMapping(google___protobuf___message___Message):
    ...
    @property
    def pairs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[MeasurementKeyMapping.MeasurementKeyPair]: ...

    def __init__(self,
        pairs : typing___Optional[typing___Iterable[MeasurementKeyMapping.MeasurementKeyPair]] = None,
        ) -> None: ...
    @classmethod
...
class ArgMapping(google___protobuf___message___Message):
    ...
    @property
    def pairs(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ArgMapping.ArgPair]: ...

    def __init__(self,
        pairs : typing___Optional[typing___Iterable[ArgMapping.ArgPair]] = None,
        ) -> None: ...
    @classmethod
