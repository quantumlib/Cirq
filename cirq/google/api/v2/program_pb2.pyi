...
class Program(google___protobuf___message___Message):
    reference_strings = ... # type: google___protobuf___internal___containers___RepeatedScalarFieldContainer[typing___Text]
    ...
    def __init__(self,
        ...
        reference_strings : typing___Optional[typing___Iterable[typing___Text]] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"circuit",u"language",u"program",u"reference_strings",u"schedule"]) -> None: ...
    else:
        ...
        def ClearField(self, field_name: typing_extensions___Literal[b"circuit",b"language",b"program",b"reference_strings",b"schedule"]) -> None: ...
...
class Arg(google___protobuf___message___Message):
    ...
    def __init__(self,
        ...
        reference_index : typing___Optional[int] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"arg",u"arg_value",u"func",u"reference_index",u"symbol"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"arg",u"arg_value",u"func",u"reference_index",u"symbol"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"arg",b"arg",u"arg_value",b"arg_value",u"func",b"func",u"reference_index",b"reference_index",u"symbol",b"symbol"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"arg",b"arg_value",b"func",b"reference_index",b"symbol"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"arg",b"arg"]) -> typing_extensions___Literal["arg_value","symbol","func","reference_index"]: ...
