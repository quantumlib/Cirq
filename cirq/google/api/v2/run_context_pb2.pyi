...
class Sweep(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"single_sweep",b"single_sweep",u"sweep",b"sweep",u"sweep_function",b"sweep_function"]) -> None: ...
...
class SweepFunction(google___protobuf___message___Message):
    ...
    class FunctionType(int):
        ...
        FUNCTION_TYPE_UNSPECIFIED = typing___cast(SweepFunction.FunctionType, 0)
        PRODUCT = typing___cast(SweepFunction.FunctionType, 1)
        ZIP = typing___cast(SweepFunction.FunctionType, 2)
    FUNCTION_TYPE_UNSPECIFIED = typing___cast(SweepFunction.FunctionType, 0)
    PRODUCT = typing___cast(SweepFunction.FunctionType, 1)
    ZIP = typing___cast(SweepFunction.FunctionType, 2)
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"function_type",b"function_type",u"sweeps",b"sweeps"]) -> None: ...
