...
class BatchedRunContext(google___protobuf___message___Message):

    @property
    def run_contexts(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[RunContext]: ...

    def __init__(self,
        run_contexts : typing___Optional[typing___Iterable[RunContext]] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> BatchedRunContext: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
