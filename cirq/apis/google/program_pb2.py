...
_PROGRAM.fields_by_name['operations'].message_type = operations__pb2._OPERATION
_PROGRAM.fields_by_name['parameter_sweep'].message_type = params__pb2._PARAMETERSWEEP
_PARAMETERIZEDRESULT.fields_by_name['params'].message_type = params__pb2._PARAMETERDICT
