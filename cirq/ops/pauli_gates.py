...
class _PauliX(Pauli, common_gates.XPowGate):
    ...
    def _with_exponent(self, exponent: value.TParamVal) -> common_gates.XPowGate:
...
class _PauliY(Pauli, common_gates.YPowGate):
    ...
    def _with_exponent(self, exponent: value.TParamVal) -> common_gates.YPowGate:
        return self.__pow__(exponent)
...
class _PauliZ(Pauli, common_gates.ZPowGate):
    ...
    def _with_exponent(self, exponent: value.TParamVal) -> common_gates.ZPowGate:
        return self.__pow__(exponent)
