...
import tempfile
import warnings
from typing import Optional, Union, Iterable, Dict, List, Tuple, TYPE_CHECKING, Set, Sequence
...
def _pad_setting(
    ...
    return InitObsSetting(init_state=init_state, observable=new_obs)
...
def measure_grouped_settings(
    ...
    *,
    ...
    while True:
        ...
        resolved_params = [
            flippy_ms.param_tuples(no_initialization=no_initialization)
...
def measure_observables_df(
    ...
    accumulators = measure_observables(
        ...
        grouper=grouper,
        readout_symmetrization=symmetrize_readout,
        readout_calibrations=readout_calibrations,
        checkpoint=True,
    )
