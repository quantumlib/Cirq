...
\Qcircuit @R=1em @C=0.75em {
 \\
 &\lstick{\text{a}}  &                                                                                                                       \qw&*+<.6em>{\text{\#2}} \POS ="i","i"+UR;"i"+UL **\dir{-};"i"+DL **\dir{-};"i"+DR **\dir{-};"i"+UR **\dir{-},"i"       \qw    & \qw\\
 &\lstick{\text{b}}  &*+<.6em>{\text{MagicOperate}} \POS ="i","i"+UR;"i"+UL **\dir{-};"i"+DL **\dir{-};"i"+DR **\dir{-};"i"+UR **\dir{-},"i" \qw&*+<.6em>{\text{MagicGate}} \POS ="i","i"+UR;"i"+UL **\dir{-};"i"+DL **\dir{-};"i"+DR **\dir{-};"i"+UR **\dir{-},"i" \qw\qwx& \qw\\
 &\lstick{\text{c}}  &                                                                                                                       \qw&*+<.6em>{\text{\#3}} \POS ="i","i"+UR;"i"+UL **\dir{-};"i"+DL **\dir{-};"i"+DR **\dir{-};"i"+UR **\dir{-},"i"       \qw\qwx& \qw\\
 \\
}""".strip()
...
\Qcircuit @R=1em @C=0.75em {
 \\
 &\lstick{\text{0}}  &\targ                                                                                                       \qw& \qw\\
 &\lstick{\text{1}}  &*+<.6em>{\text{Y}} \POS ="i","i"+UR;"i"+UL **\dir{-};"i"+DL **\dir{-};"i"+DR **\dir{-};"i"+UR **\dir{-},"i" \qw& \qw\\
 &\lstick{\text{2}}  &*+<.6em>{\text{Z}} \POS ="i","i"+UR;"i"+UL **\dir{-};"i"+DL **\dir{-};"i"+DR **\dir{-};"i"+UR **\dir{-},"i" \qw& \qw\\
 \\
}""".strip()
    assert_has_qcircuit_diagram(circuit, expected_diagram)
...
\Qcircuit @R=1em @C=0.75em {
 \\
 &\lstick{\text{0}}  &\ar @{-} [1, 1]  \qw&                    & \qw& \qw\\
 &\lstick{\text{1}}  &\ar @{-} [-1, 1] \qw&\ar @{-} [1, 1]     &    & \qw\\
 &\lstick{\text{2}}  &                 \qw&\ar @{-} [-1, 1] \qw&    & \qw\\
 \\
}""".strip()
    assert_has_qcircuit_diagram(circuit, expected_diagram)
...
\Qcircuit @R=1em @C=0.75em {
 \\
 &\lstick{\text{0}}  &\ar @{-} [1, 1]  \qw&    &                         \qw& \qw\\
 &\lstick{\text{1}}  &\ar @{-} [-1, 1] \qw&    &\multigate{1}{\text{XX}} \qw& \qw\\
 &\lstick{\text{2}}  &                 \qw& \qw&\ghost{\text{XX}}        \qw& \qw\\
 \\
}""".strip()
    assert_has_qcircuit_diagram(circuit, expected_diagram)
...
\Qcircuit @R=1em @C=0.75em {
 \\
 &\lstick{\text{0}}  &\ar @{-} [1, 1]  \qw&         & \qw\\
 &\lstick{\text{1}}  &\ar @{-} [-1, 1] \qw&         & \qw\\
 &\lstick{\text{2}}  &                 \qw&\targ \qw& \qw\\
 \\
}""".strip()
    assert_has_qcircuit_diagram(circuit, expected_diagram)
