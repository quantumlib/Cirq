...
def test_noise_composition():
    ...
    def merge(circuit):
        ...
        cirq.optimizers.merge_single_qubit_gates_into_phased_x_z(decomposed)
        return decomposed
    ...
    actual_zs = merge(actual_zs)
    actual_sz = merge(actual_sz)
    expected_circuit = merge(expected_circuit)
