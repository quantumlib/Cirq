...
class _SwapPrintGate(ops.Gate):
    ...
    def __init__(self, qubits: tuple[tuple[ops.Qid, ops.Qid], ...]) -> None:
        self.qubits = qubits
...
def routed_circuit_with_mapping(
    routed_circuit: circuits.AbstractCircuit, initial_map: dict[ops.Qid, ops.Qid] | None = None
    ...
    def swap_print_moment() -> ops.Operation:
