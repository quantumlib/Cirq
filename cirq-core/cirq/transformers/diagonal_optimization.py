...
from cirq.transformers import eject_z, transformer_api, transformer_primitives
    ...
    *,
    ...
    for moment in reversed(circuit):
        ...
        for op in moment:
            ...
            # (diagonal gates only affect phase, which doesn't impact computational basis measurements)
