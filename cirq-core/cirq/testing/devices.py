...
class ValidatingTestDevice(devices.Device):
    """A fake device that ensures Device validation features are leveraged in Circuit functions.

    It contains the minimum set of features that tests require. Feel free to extend the features
    here as needed.
