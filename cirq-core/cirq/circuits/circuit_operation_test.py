...
def test_with_measurement_keys():
    ...
    assert cirq.measurement_keys_str(op_with_keys) == {'pa', 'mb'}
...
def test_decompose_repeated_nested_measurements():
    ...
    assert cirq.measurement_keys_str(op3) == set(expected_measurement_keys_in_order)
    ...
    assert cirq.measurement_keys_str(expected_circuit) == set(expected_measurement_keys_in_order)
