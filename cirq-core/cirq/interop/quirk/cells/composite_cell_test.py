...
def test_custom_circuit_gate():
    ...
    assert_url_to_circuit_returns(
        ...
        cirq.Circuit(cirq.interop.quirk.QuirkArithmeticOperation('+=A1', target=[2], inputs=[[2]]).on(b, a)),
    )
    ...
    assert_url_to_circuit_returns(
        ...
        cirq.Circuit(
            cirq.interop.quirk.QuirkArithmeticOperation('+=A2', target=[2, 2], inputs=[[2, 2]]).on(a, b, d, e),
            cirq.interop.quirk.QuirkArithmeticOperation('+=A2', target=[2, 2], inputs=[[2, 2]]).on(b, c, d, e),
            cirq.interop.quirk.QuirkArithmeticOperation('+=A2', target=[2, 2], inputs=[[2, 2]]).on(b, c, d, e),
        ),
    )
