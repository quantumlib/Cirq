...
class CountingSimulationState(cirq.DenseSimulationState[CountingState]):
...
class CountingSimulator(
    ...
    def _create_simulator_trial_result(
        ...
        final_simulator_state: 'cirq.SimulationState[CountingSimulationState]',
    ) -> CountingTrialResult:
    ...
    def _create_step_result(
        self, sim_state: cirq.SimulationState[CountingSimulationState]
    ) -> CountingStepResult:
