...
from cirq.sim.dense_simulation_state import DenseSimulationState, strat_act_on_from_apply_decompose
...
class DensityMatrixSimulationState(DenseSimulationState[_BufferedDensityMatrix]):
