...
class CliffordSimulator(
    ...
    def _create_partial_act_on_args(
        self,
        initial_state: Union[int, 'cirq.CHFormSimulationState'],
        qubits: Sequence['cirq.Qid'],
        classical_data: 'cirq.ClassicalDataStore',
    ) -> 'cirq.CHFormSimulationState':
        """Creates the CHFormSimulationState for a circuit.
        ...
        Returns:
            CHFormSimulationState for the circuit.
        """
        if isinstance(initial_state, clifford.CHFormSimulationState):
            return initial_state

        return clifford.CHFormSimulationState(
            prng=self._prng,
    ...
    def _create_step_result(
        self, sim_state: 'cirq.SimulationState[clifford.CHFormSimulationState]'
    ):
    ...
    def _create_simulator_trial_result(
        ...
        final_simulator_state: 'cirq.SimulationState[cirq.CHFormSimulationState]',
    ):
...
class CliffordTrialResult(
    simulator_base.SimulationTrialResultBase['clifford.CHFormSimulationState']
):
...
class CliffordSimulatorStepResult(simulator_base.StepResultBase['cirq.CHFormSimulationState']):
    """A `StepResult` that includes `StateVectorMixin` methods."""

    def __init__(self, sim_state: 'cirq.SimulationState[clifford.CHFormSimulationState]'):
...
class CliffordState:
    ...
    def apply_unitary(self, op: 'cirq.Operation'):
        ch_form_args = clifford.CHFormSimulationState(
