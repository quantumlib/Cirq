...
class ActOnDensityMatrixArgs(ActOnArgs):
    ...
    def _on_kron(self, other: 'ActOnDensityMatrixArgs', target: 'ActOnDensityMatrixArgs'):
    ...
    def _on_transpose(self, qubits: Sequence['cirq.Qid'], target: 'ActOnDensityMatrixArgs'):
