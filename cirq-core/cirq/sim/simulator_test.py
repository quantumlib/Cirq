...
def test_run_simulator_run():
    ...
    expected_result = cirq.ResultImpl(measurements=expected_measurements, params=param_resolver)
...
def test_run_simulator_sweeps():
    ...
    for resolver in param_resolvers:
        resolver.param_dict = {}
    expected_results = [
        cirq.ResultImpl(measurements=expected_measurements, params=param_resolvers[0]),
        cirq.ResultImpl(measurements=expected_measurements, params=param_resolvers[1]),
    ]
