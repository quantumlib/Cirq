...
class PauliStringPhasor(gate_operation.GateOperation):
    ...
    The -1 eigenstates of the Pauli string will have their amplitude multiplied by a factor of
    $e^{i \pi exponent_neg}$ while +1 eigenstates of the Pauli string will have their amplitude
    multiplied by $e^{i \pi exponent_pos}$.
    """
