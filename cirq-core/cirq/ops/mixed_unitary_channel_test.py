...
def test_matrix_mixture_from_mixture():
    ...
    assert cirq.measurement_key_str(mm) == 'dp'
...
def test_matrix_mixture_remap_keys():
    ...
    assert cirq.measurement_key_str(cirq.with_key_path(mm_x, ('path',))) == 'path:x'
...
def test_matrix_mixture_from_unitaries():
    ...
    assert cirq.measurement_key_str(half_flip) == 'flip'
