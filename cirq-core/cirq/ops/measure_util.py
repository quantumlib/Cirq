    ...
    *target,
    ...
    Args:
        *target: The qubits that the measurement gate should measure.
        ...
        key: The string key or MeasurementKey for the measurement. If this is
            None, it defaults to a comma-separated list of `str(qubit)` for
            each of the target qubits.
