...
def test_kraus_channel_from_channel():
    ...
    assert cirq.measurement_key_str(kc) == 'dp'
...
def test_kraus_channel_remap_keys():
    ...
    assert cirq.measurement_key_str(cirq.with_key_path(kc_x, ('path',))) == 'path:x'
...
def test_kraus_channel_from_kraus():
    ...
    assert cirq.measurement_key_str(x_meas) == 'x_meas'
