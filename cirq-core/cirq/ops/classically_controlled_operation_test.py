...
def test_scope_local() -> None:
    ...
    cirq.testing.assert_has_diagram(
      ...
      [       [ 0: ───M───X─── ]                                      ]
0: ───[ 0: ───[       ║   ║    ]───────────────────────────────────── ]─────────────────────────────────────
      [       [ a: ═══V═══@═══ ](loops=2, use_repetition_ids=True)    ](loops=2, use_repetition_ids=True)
""",  # noqa: E501
        use_unicode_characters=True,
    )
    cirq.testing.assert_has_diagram(
...
def test_scope_flatten_inner() -> None:
    ...
    cirq.testing.assert_has_diagram(
      ...
      [       [ 0: ───M───X─── ]             ]
0: ───[ 0: ───[       ║   ║    ]──────────── ]─────────────────────────────────────
      [       [ a: ═══V═══@═══ ](loops=2)    ](loops=2, use_repetition_ids=True)
""",
        use_unicode_characters=True,
    )
    cirq.testing.assert_has_diagram(
...
def test_scope_flatten_outer() -> None:
    ...
    cirq.testing.assert_has_diagram(
      ...
      [       [ 0: ───M───X─── ]                                      ]
0: ───[ 0: ───[       ║   ║    ]───────────────────────────────────── ]────────────
      [       [ a: ═══V═══@═══ ](loops=2, use_repetition_ids=True)    ](loops=2)
""",
        use_unicode_characters=True,
    )
    cirq.testing.assert_has_diagram(
...
0: ───[       ║   [ b: ════════════@═══ ](loops=2, use_repetition_ids=True)    ]─────────────────────────────────────
      [       ║   ║                                                            ]
      [ b: ═══V═══╩═══════════════════════════════════════════════════════════ ](loops=2, use_repetition_ids=True)
""",  # noqa: E501
        use_unicode_characters=True,
    )
    cirq.testing.assert_has_diagram(
