...
class ApplyUnitaryArgs:
    ...
    Attributes:
        ...
        slices: Which slices the unitary effect is being applied to (e.g. the
            subdimensions of qudits that the gate is operating on).
    """
    ...
    def _for_operation_with_qid_shape(
        ...
        Args:
            ...
            slices: The slices of the operation, the expected number of
                quantum slices in each qudit the operation applies to.
