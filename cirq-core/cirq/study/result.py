...
class Result(abc.ABC):
    ...
    def records(self) -> Mapping[str, np.ndarray]:
        ...
        The value for each key is a 3-D array of booleans, with the first index running over
        circuit repetitions, the second index running over instances of the measurement key in the
        circuit, and the third index running over the qubits for the corresponding measurements.
        """
