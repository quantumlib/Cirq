...
def get_multigate_parameters(args: 'cirq.CircuitDiagramInfoArgs') -> Optional[Tuple[int, int]]:
...
def hardcoded_qcircuit_diagram_info(op: 'cirq.Operation') -> Optional['cirq.CircuitDiagramInfo']:
