...
class MPSSimulator(
    ...
    def _create_step_result(self, sim_state: 'cirq.SimulationState[MPSState]'):
    ...
    def _create_simulator_trial_result(
        ...
        final_simulator_state: 'cirq.SimulationState[MPSState]',
    ) -> 'MPSTrialResult':
...
class MPSSimulatorStepResult(simulator_base.StepResultBase['MPSState']):
    ...
    def __init__(self, sim_state: 'cirq.SimulationState[MPSState]'):
...
@value.value_equality
class MPSState(DenseSimulationState[_MPSHandler]):
