...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n#cirq_google/api/v1/operations.proto\x12\x12\x63irq_google.api.v1\"!\n\x05Qubit\x12\x0b\n\x03row\x18\x01 \x01(\x05\x12\x0b\n\x03\x63ol\x18\x02 \x01(\x05\"E\n\x12ParameterizedFloat\x12\r\n\x03raw\x18\x01 \x01(\x02H\x00\x12\x17\n\rparameter_key\x18\x02 \x01(\tH\x00\x42\x07\n\x05value\"\xae\x01\n\x04\x45xpW\x12)\n\x06target\x18\x01 \x01(\x0b\x32\x19.cirq_google.api.v1.Qubit\x12?\n\x0f\x61xis_half_turns\x18\x02 \x01(\x0b\x32&.cirq_google.api.v1.ParameterizedFloat\x12:\n\nhalf_turns\x18\x03 \x01(\x0b\x32&.cirq_google.api.v1.ParameterizedFloat\"m\n\x04\x45xpZ\x12)\n\x06target\x18\x01 \x01(\x0b\x32\x19.cirq_google.api.v1.Qubit\x12:\n\nhalf_turns\x18\x02 \x01(\x0b\x32&.cirq_google.api.v1.ParameterizedFloat\"\x9b\x01\n\x05\x45xp11\x12*\n\x07target1\x18\x01 \x01(\x0b\x32\x19.cirq_google.api.v1.Qubit\x12*\n\x07target2\x18\x02 \x01(\x0b\x32\x19.cirq_google.api.v1.Qubit\x12:\n\nhalf_turns\x18\x03 \x01(\x0b\x32&.cirq_google.api.v1.ParameterizedFloat\"[\n\x0bMeasurement\x12*\n\x07targets\x18\x01 \x03(\x0b\x32\x19.cirq_google.api.v1.Qubit\x12\x0b\n\x03key\x18\x02 \x01(\t\x12\x13\n\x0binvert_mask\x18\x03 \x03(\x08\"\xfa\x01\n\tOperation\x12%\n\x1dincremental_delay_picoseconds\x18\x01 \x01(\x04\x12)\n\x05\x65xp_w\x18\n \x01(\x0b\x32\x18.cirq_google.api.v1.ExpWH\x00\x12)\n\x05\x65xp_z\x18\x0b \x01(\x0b\x32\x18.cirq_google.api.v1.ExpZH\x00\x12+\n\x06\x65xp_11\x18\x0c \x01(\x0b\x32\x19.cirq_google.api.v1.Exp11H\x00\x12\x36\n\x0bmeasurement\x18\r \x01(\x0b\x32\x1f.cirq_google.api.v1.MeasurementH\x00\x42\x0b\n\toperationB2\n\x1d\x63om.google.cirq.google.api.v1B\x0fOperationsProtoP\x01\x62\x06proto3')
)
...
_QUBIT = _descriptor.Descriptor(
  name='Qubit',
  full_name='cirq_google.api.v1.Qubit',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='row', full_name='cirq_google.api.v1.Qubit.row', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='col', full_name='cirq_google.api.v1.Qubit.col', index=1,
...
_PARAMETERIZEDFLOAT = _descriptor.Descriptor(
  ...
  full_name='cirq_google.api.v1.ParameterizedFloat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='raw', full_name='cirq_google.api.v1.ParameterizedFloat.raw', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parameter_key', full_name='cirq_google.api.v1.ParameterizedFloat.parameter_key', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='cirq_google.api.v1.ParameterizedFloat.value',
...
_EXPW = _descriptor.Descriptor(
  name='ExpW',
  full_name='cirq_google.api.v1.ExpW',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='target', full_name='cirq_google.api.v1.ExpW.target', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='axis_half_turns', full_name='cirq_google.api.v1.ExpW.axis_half_turns', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='half_turns', full_name='cirq_google.api.v1.ExpW.half_turns', index=2,
...
_EXPZ = _descriptor.Descriptor(
  name='ExpZ',
  full_name='cirq_google.api.v1.ExpZ',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='target', full_name='cirq_google.api.v1.ExpZ.target', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='half_turns', full_name='cirq_google.api.v1.ExpZ.half_turns', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXP11 = _descriptor.Descriptor(
  name='Exp11',
  full_name='cirq_google.api.v1.Exp11',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='target1', full_name='cirq_google.api.v1.Exp11.target1', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target2', full_name='cirq_google.api.v1.Exp11.target2', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='half_turns', full_name='cirq_google.api.v1.Exp11.half_turns', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MEASUREMENT = _descriptor.Descriptor(
  name='Measurement',
  full_name='cirq_google.api.v1.Measurement',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='targets', full_name='cirq_google.api.v1.Measurement.targets', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key', full_name='cirq_google.api.v1.Measurement.key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='invert_mask', full_name='cirq_google.api.v1.Measurement.invert_mask', index=2,
...
_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='cirq_google.api.v1.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='incremental_delay_picoseconds', full_name='cirq_google.api.v1.Operation.incremental_delay_picoseconds', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exp_w', full_name='cirq_google.api.v1.Operation.exp_w', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exp_z', full_name='cirq_google.api.v1.Operation.exp_z', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exp_11', full_name='cirq_google.api.v1.Operation.exp_11', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='measurement', full_name='cirq_google.api.v1.Operation.measurement', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='cirq_google.api.v1.Operation.operation',
      index=0, containing_type=None, fields=[]),
  ],
...
Qubit = _reflection.GeneratedProtocolMessageType('Qubit', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.Qubit)
  })
...
ParameterizedFloat = _reflection.GeneratedProtocolMessageType('ParameterizedFloat', (_message.Message,), {
  ...
  '__module__' : 'cirq_google.api.v1.operations_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ParameterizedFloat)
  })
...
ExpW = _reflection.GeneratedProtocolMessageType('ExpW', (_message.Message,), {
  'DESCRIPTOR' : _EXPW,
  '__module__' : 'cirq_google.api.v1.operations_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ExpW)
  })
...
ExpZ = _reflection.GeneratedProtocolMessageType('ExpZ', (_message.Message,), {
  'DESCRIPTOR' : _EXPZ,
  '__module__' : 'cirq_google.api.v1.operations_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ExpZ)
  })
...
Exp11 = _reflection.GeneratedProtocolMessageType('Exp11', (_message.Message,), {
  'DESCRIPTOR' : _EXP11,
  '__module__' : 'cirq_google.api.v1.operations_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.Exp11)
  })
...
Measurement = _reflection.GeneratedProtocolMessageType('Measurement', (_message.Message,), {
  ...
  '__module__' : 'cirq_google.api.v1.operations_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.Measurement)
  })
...
Operation = _reflection.GeneratedProtocolMessageType('Operation', (_message.Message,), {
  ...
  '__module__' : 'cirq_google.api.v1.operations_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.Operation)
  })
