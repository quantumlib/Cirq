...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1f\x63irq_google/api/v1/params.proto\x12\x12\x63irq_google.api.v1\"V\n\x0eParameterSweep\x12\x13\n\x0brepetitions\x18\x01 \x01(\x05\x12/\n\x05sweep\x18\x02 \x01(\x0b\x32 .cirq_google.api.v1.ProductSweep\"=\n\x0cProductSweep\x12-\n\x07\x66\x61\x63tors\x18\x01 \x03(\x0b\x32\x1c.cirq_google.api.v1.ZipSweep\";\n\x08ZipSweep\x12/\n\x06sweeps\x18\x01 \x03(\x0b\x32\x1f.cirq_google.api.v1.SingleSweep\"\x8d\x01\n\x0bSingleSweep\x12\x15\n\rparameter_key\x18\x01 \x01(\t\x12,\n\x06points\x18\x02 \x01(\x0b\x32\x1a.cirq_google.api.v1.PointsH\x00\x12\x30\n\x08linspace\x18\x03 \x01(\x0b\x32\x1c.cirq_google.api.v1.LinspaceH\x00\x42\x07\n\x05sweep\"\x18\n\x06Points\x12\x0e\n\x06points\x18\x01 \x03(\x02\"G\n\x08Linspace\x12\x13\n\x0b\x66irst_point\x18\x01 \x01(\x02\x12\x12\n\nlast_point\x18\x02 \x01(\x02\x12\x12\n\nnum_points\x18\x03 \x01(\x03\"\x8c\x01\n\rParameterDict\x12G\n\x0b\x61ssignments\x18\x01 \x03(\x0b\x32\x32.cirq_google.api.v1.ParameterDict.AssignmentsEntry\x1a\x32\n\x10\x41ssignmentsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\x02:\x02\x38\x01\x42.\n\x1d\x63om.google.cirq.google.api.v1B\x0bParamsProtoP\x01\x62\x06proto3')
)
...
_PARAMETERSWEEP = _descriptor.Descriptor(
  name='ParameterSweep',
  full_name='cirq_google.api.v1.ParameterSweep',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='repetitions', full_name='cirq_google.api.v1.ParameterSweep.repetitions', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='sweep', full_name='cirq_google.api.v1.ParameterSweep.sweep', index=1,
...
_PRODUCTSWEEP = _descriptor.Descriptor(
  name='ProductSweep',
  full_name='cirq_google.api.v1.ProductSweep',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='factors', full_name='cirq_google.api.v1.ProductSweep.factors', index=0,
...
_ZIPSWEEP = _descriptor.Descriptor(
  name='ZipSweep',
  full_name='cirq_google.api.v1.ZipSweep',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sweeps', full_name='cirq_google.api.v1.ZipSweep.sweeps', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SINGLESWEEP = _descriptor.Descriptor(
  name='SingleSweep',
  full_name='cirq_google.api.v1.SingleSweep',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='parameter_key', full_name='cirq_google.api.v1.SingleSweep.parameter_key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='points', full_name='cirq_google.api.v1.SingleSweep.points', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='linspace', full_name='cirq_google.api.v1.SingleSweep.linspace', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='sweep', full_name='cirq_google.api.v1.SingleSweep.sweep',
...
_POINTS = _descriptor.Descriptor(
  name='Points',
  full_name='cirq_google.api.v1.Points',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='points', full_name='cirq_google.api.v1.Points.points', index=0,
...
_LINSPACE = _descriptor.Descriptor(
  name='Linspace',
  full_name='cirq_google.api.v1.Linspace',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='first_point', full_name='cirq_google.api.v1.Linspace.first_point', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_point', full_name='cirq_google.api.v1.Linspace.last_point', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_points', full_name='cirq_google.api.v1.Linspace.num_points', index=2,
...
_PARAMETERDICT_ASSIGNMENTSENTRY = _descriptor.Descriptor(
  ...
  full_name='cirq_google.api.v1.ParameterDict.AssignmentsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='cirq_google.api.v1.ParameterDict.AssignmentsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='cirq_google.api.v1.ParameterDict.AssignmentsEntry.value', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PARAMETERDICT = _descriptor.Descriptor(
  name='ParameterDict',
  full_name='cirq_google.api.v1.ParameterDict',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='assignments', full_name='cirq_google.api.v1.ParameterDict.assignments', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ParameterSweep = _reflection.GeneratedProtocolMessageType('ParameterSweep', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ParameterSweep)
  })
...
ProductSweep = _reflection.GeneratedProtocolMessageType('ProductSweep', (_message.Message,), {
  ...
  '__module__' : 'cirq_google.api.v1.params_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ProductSweep)
  })
...
ZipSweep = _reflection.GeneratedProtocolMessageType('ZipSweep', (_message.Message,), {
  ...
  '__module__' : 'cirq_google.api.v1.params_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ZipSweep)
  })
...
SingleSweep = _reflection.GeneratedProtocolMessageType('SingleSweep', (_message.Message,), {
  ...
  '__module__' : 'cirq_google.api.v1.params_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.SingleSweep)
  })
...
Points = _reflection.GeneratedProtocolMessageType('Points', (_message.Message,), {
  'DESCRIPTOR' : _POINTS,
  '__module__' : 'cirq_google.api.v1.params_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.Points)
  })
...
Linspace = _reflection.GeneratedProtocolMessageType('Linspace', (_message.Message,), {
  ...
  '__module__' : 'cirq_google.api.v1.params_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.Linspace)
  })
...
ParameterDict = _reflection.GeneratedProtocolMessageType('ParameterDict', (_message.Message,), {
  ...
  'AssignmentsEntry' : _reflection.GeneratedProtocolMessageType('AssignmentsEntry', (_message.Message,), {
    ...
    '__module__' : 'cirq_google.api.v1.params_pb2'
    # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ParameterDict.AssignmentsEntry)
    })
  ,
  'DESCRIPTOR' : _PARAMETERDICT,
  '__module__' : 'cirq_google.api.v1.params_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v1.ParameterDict)
  })
