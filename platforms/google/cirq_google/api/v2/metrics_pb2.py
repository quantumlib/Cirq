...
_METRICSSNAPSHOT = _descriptor.Descriptor(
  ...
  full_name='cirq_google.api.v2.MetricsSnapshot',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp_ms', full_name='cirq_google.api.v2.MetricsSnapshot.timestamp_ms', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='metrics', full_name='cirq_google.api.v2.MetricsSnapshot.metrics', index=1,
...
_METRIC = _descriptor.Descriptor(
  name='Metric',
  full_name='cirq_google.api.v2.Metric',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='cirq_google.api.v2.Metric.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='targets', full_name='cirq_google.api.v2.Metric.targets', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='values', full_name='cirq_google.api.v2.Metric.values', index=2,
...
_VALUE = _descriptor.Descriptor(
  name='Value',
  full_name='cirq_google.api.v2.Value',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='double_val', full_name='cirq_google.api.v2.Value.double_val', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int32_val', full_name='cirq_google.api.v2.Value.int32_val', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int64_val', full_name='cirq_google.api.v2.Value.int64_val', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='str_val', full_name='cirq_google.api.v2.Value.str_val', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='val', full_name='cirq_google.api.v2.Value.val',
...
MetricsSnapshot = _reflection.GeneratedProtocolMessageType('MetricsSnapshot', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:cirq_google.api.v2.MetricsSnapshot)
  })
...
Metric = _reflection.GeneratedProtocolMessageType('Metric', (_message.Message,), {
  'DESCRIPTOR' : _METRIC,
  '__module__' : 'cirq_google.api.v2.metrics_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v2.Metric)
  })
...
Value = _reflection.GeneratedProtocolMessageType('Value', (_message.Message,), {
  'DESCRIPTOR' : _VALUE,
  '__module__' : 'cirq_google.api.v2.metrics_pb2'
  # @@protoc_insertion_point(class_scope:cirq_google.api.v2.Value)
  })
