...
class EngineJob:
    ...
    def results(self) -> List[study.Result]:
        ...
        if not self._results:
            ...
            if (result_type == 'cirq_google.api.v1.Result' or
            ...
            elif (result_type == 'cirq_google.api.v2.Result' or
